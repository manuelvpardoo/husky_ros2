...
def main():
    ...
    gripper_interface = GripperInterface(
        node=node,
        gripper_joint_names=ur.gripper_joint_names(),
        open_gripper_joint_positions=ur.OPEN_GRIPPER_JOINT_POSITIONS,
        closed_gripper_joint_positions=ur.CLOSED_GRIPPER_JOINT_POSITIONS,
        gripper_group_name=ur.MOVE_GROUP_GRIPPER,
